...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int myProgress = audioManager.getStreamVolume(AudioManager.STREAM_MUSIC);


        final SeekBar volumeRocker = findViewById(R.id.seekBar);
        volumeRocker.setProgress(myProgress);
       ...
       final  SeekBar timeline = (SeekBar)findViewById(R.id.timeline);
        ...
        new Timer().scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                timeline.setProgress(mediaPlayer.getDuration());
            }
        },0 , 1000);
